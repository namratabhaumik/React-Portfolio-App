...
const socials = [
  ...
  {
    icon: faGithub,
    url: "https://github.com/namratabhaumik",
  },
  {
    icon: faLinkedin,
    url: "http://www.linkedin.com/in/namratabhaumik",
  },
];
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (prevScrollPos > currentScrollPos) {
        headerElement.style.transform = "translateY(0)"; //header hides while scrolling down
      } else {
        headerElement.style.transform = "translateY(-200px)"; //header appears while scrolling up
      }
